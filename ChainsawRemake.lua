...
for i = 1, 15 do game.ReplicatedStorage.Events.Tools:FireServer("Oreo", game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool"), game:GetService("ReplicatedStorage").Sounds.Map.Close_Default_Door) task.wait(0.1) end
