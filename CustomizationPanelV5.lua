...
-- Get or reuse Accessories folder
...
-- Ensure Shirts + Pants + TShirts subfolders exist
...
-- Helper to get all items of a class from ClothingFolder subfolders
...
local function saveCharacterStuff(char, AccessoryFolder, ShirtsFolder, PantsFolder, TShirtsFolder)
	...
	-- Save accessories (avoid duplicates)
	...
	-- Save t-shirts (avoid duplicates)
...
tshirtsSubTab.TextSize = 14
tshirtsSubTab.TextColor3 = Color3.fromRGB(255, 255, 255)
tshirtsSubTab.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
tshirtsFrame.ScrollBarThickness = 8
...
tshirtsGrid.CellSize = UDim2.new(0, 120, 0, 140)
...
tshirtsSubTab.MouseButton1Click:Connect(function()
	tshirtsSubTab.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
	shirtsSubTab.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
	pantsSubTab.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
local function createClothingButton(item, fromCharacter)
	...
	if item:IsA("Shirt") then
		targetFrame = shirtsFrame
	elseif item:IsA("Pants") then
		targetFrame = pantsFrame
	elseif item:IsA("ShirtGraphic") then
		targetFrame = tshirtsFrame
	end
	...
	button:SetAttribute("IsPants", item:IsA("Pants"))
	button:SetAttribute("IsTShirt", item:IsA("ShirtGraphic"))
	...
	elseif item:IsA("ShirtGraphic") then
		id = tonumber(item.Graphic:match("%d+")) or 0
	end
