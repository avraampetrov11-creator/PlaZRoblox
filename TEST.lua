...
local PlaceholderFolder = ReplicatedStorage.Homework_Related.Answer_Types
Core_Replication:FireServer("Tools", "Add", PlaceholderFolder, ReplicatedStorage.Misc)
task.wait(2)
Core_Replication:FireServer("Tools", "Add", PlaceholderFolder, ReplicatedStorage.Misc.Answer_Types)
task.wait(2)

local AccesoryFolder = ReplicatedStorage.Misc.Answer_Types.Answer_Types
AccesoryFolder:SetAttribute("AccesoryFolder",true)
for _, child in ipairs(AccesoryFolder:GetChildren()) do
	Core_Replication:FireServer("Tools", "Remove", child, AccesoryFolder)
end
task.wait(2)
Core_Replication:FireServer("Tools", "Add", PlaceholderFolder, ReplicatedStorage.Misc.Answer_Types)
local ClothingFolder = nil
for _, child in ipairs(AccesoryFolder:GetChildren()) do
	Core_Replication:FireServer("Tools", "Remove", child, ReplicatedStorage.Misc)
end
